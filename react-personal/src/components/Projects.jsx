  ...
  return (
    <div class="bg-gradient-to-l from-cyan-700 to-slate-500 py-16 h-screen">
      <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <Link
          to="/"
          class="text-2xl absolute rotate-180 rounded-full p-8 top-0 left-0 animate-pulse"
        >
          →
        </Link>
        ...
        <div class="mt-10 grid gap-8 sm:grid-cols-2 lg:grid-cols-3">
          <div class="bg-white rounded-lg shadow-lg overflow-hidden transform transition-transform duration-300 group-hover:-translate-y-2">
            <div class="p-6">
              <h3 class="text-xl font-semibold text-gray-800 pt-1 pb-1">
                Finance Web App
              </h3>
              ...
              <div class="mt-4 flex space-x-4">
                <Link
                  to="https://n00b110.pythonanywhere.com/"
                  class="text-indigo-500 hover:underline"
                >
                  Live Demo
                </Link>
                <Link
                  to="https://github.com/n00b110/bank-project"
                  class="text-indigo-500 hover:underline"
                >
                  GitHub
                </Link>
